/*
 * Copyright © 2021 Valois Foundation
 *
...
import { valoisGenesisBlockUrl } from '../../utils/commons';
...
export default class DownloadCommand extends Command {
	...
	static examples = [
		...
		'genesis-block:download --network --data-path ./valois/',
		'genesis-block:download --url http://mydomain.com/genesis_block.json.gz --data-path ./valois/ --force',
	];
	...
	async run(): Promise<void> {
		...
		const downloadUrl = url ?? valoisGenesisBlockUrl(DOWNLOAD_URL, network as NETWORK);
