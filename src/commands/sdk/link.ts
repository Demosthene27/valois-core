...
export default class LinkCommand extends Command {
	...
	static examples = ['sdk:link /path/to/valois-sdk/sdk'];

	static args = [
		{ name: 'targetSDKFolder', required: true, description: 'The path to the valois SDK folder' },
	];
	...
	async run(): Promise<void> {
		...
		const sdkLocalPath = join(__dirname, '../../../', 'node_modules', 'valois-sdk');
