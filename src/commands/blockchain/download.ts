...
import { valoisSnapshotUrl } from '../../utils/commons';
...
export default class DownloadCommand extends Command {
	...
	static examples = [
		...
		'download --url https://snapshots.valois.io/mainnet/blockchain.db.tar.gz --output ./downloads',
	];
	...
	async run(): Promise<void> {
		...
		const url = flags.url ? flags.url : valoisSnapshotUrl(SNAPSHOT_URL, network);
