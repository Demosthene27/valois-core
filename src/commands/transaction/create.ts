...
import { codec, cryptography, transactions, validator } from 'valois-sdk';
...
export default class CreateCommand extends BaseIPCCommand {
	...
	async run(): Promise<void> {
		...
		if (assetErrors.length) {
			throw new validator.ValoisValidationError([...assetErrors]);
		}
		...
		if (transactionErrors.length) {
			throw new validator.ValoisValidationError([...transactionErrors]);
		}
