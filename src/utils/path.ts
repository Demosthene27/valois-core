...
import { PartialApplicationConfig, systemDirs } from 'valois-sdk';

const defaultDir = '.valois';
const defaultFolder = 'valois-core';
...
export const getSocketsPath = (dataPath: string, network = defaultFolder): SocketPaths => {
	...
	return {
		...
		pub: `unix://${dirs.sockets}/valois_pub.sock`,
		sub: `unix://${dirs.sockets}/valois_sub.sock`,
