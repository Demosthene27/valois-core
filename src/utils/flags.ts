...
export const flags: FlagMap = {
	...
	network: {
		char: 'n',
		description:
			'Default network config to use. Environment variable "VALOIS_NETWORK" can also be used.',
	},
	networkIdentifier: {
		description: 'Network identifier defined for the network or main | test for the Valois Network.',
	},
};
