...
ifndef $(CORE_VERSION)
release: dist/channels/$(CORE_CHANNEL)/valois-core-v$(CORE_VERSION)

dist/channels/$(CORE_CHANNEL)/valois-core-v$(CORE_VERSION):
	npx oclif-dev pack --targets=linux-x64,darwin-x64
else
release: dist/valois-core-v$(CORE_VERSION)

dist/valois-core-v$(CORE_VERSION):
	npx oclif-dev pack --targets=linux-x64,darwin-x64
endif
